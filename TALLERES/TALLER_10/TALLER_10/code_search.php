    ...
    <div class="container">
        ...
        <form class="search-form" method="GET">
            ...
            <div>
                ...
                <input type="text" id="language" name="language" value="<?= htmlspecialchars($language) ?>">
            </div>

            <div>
                <label for="extension">Extensión del archivo:</label>
                <input type="text" id="extension" name="extension" value="<?= htmlspecialchars($extension) ?>">
            </div>
                ...
                <?php foreach ($results['items'] as $item) : ?>
                    <div class="code-result">
                        <div class="file-info">
                            ...
                            <a href="<?= htmlspecialchars($item['repository']['html_url']) ?>" target="_blank">
