    ...
    <div class="container">
        ...
        <form class="search-form" method="GET">
            <div class="form-group">
                ...
                <input type="text" id="keyword" name="keyword" value="<?= htmlspecialchars($filters['keyword']) ?>">
            </div>

            <div class="form-group">
                <label for="language">Lenguaje:</label>
                <input type="text" id="language" name="language" value="<?= htmlspecialchars($filters['language']) ?>">
            </div>

            <div class="form-group">
                <label for="stars">Estrellas mínimas:</label>
                <input type="number" id="stars" name="stars" value="<?= htmlspecialchars($filters['stars']) ?>">
            </div>

            <div class="form-group">
                <label for="created">Creado después de (YYYY-MM-DD):</label>
                <input type="date" id="created" name="created" value="<?= htmlspecialchars($filters['created']) ?>">
            </div>

            <div class="form-group">
                <label for="topic">Topic:</label>
                <input type="text" id="topic" name="topic" value="<?= htmlspecialchars($filters['topic']) ?>">
            </div>
