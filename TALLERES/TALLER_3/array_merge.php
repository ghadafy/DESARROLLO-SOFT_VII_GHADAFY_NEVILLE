...
$misComidas = ["Arroz con huevo", "Maccarrones gruesos con mucha salga y queso parmesano", "Pescado y MArisco"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Dios", "Dios", "Dios"]; // Reemplaza con las comidas favoritas de tu amigo
