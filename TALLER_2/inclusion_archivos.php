...
/*
La linea siguiente se comenta porque al incluir nuevamente, pero a traves del require el archivo  
'funciones_utiles.php' se estaria definiendo la funcion doblar() dos veces lo que arrojaria un error
*/
